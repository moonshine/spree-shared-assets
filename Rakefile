...
desc 'Generate documentation for the shared_assets extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'SharedAssetsExtension'
...
desc 'Test the shared_assets extension.'
...
namespace :test do
  desc 'Functional test the shared_assets extension.'
  ...
  desc 'Unit test the shared_assets extension.'
